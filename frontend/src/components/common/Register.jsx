...
const Register = () => {
   ...
   const handleSubmit = (e) => {
      ...
      if (!data?.name || !data?.email || !data?.password || !data?.type) {
         ...
         return alert("Registration not successful: Invalid email format");
      }
      ...
      axiosInstance.post('/api/user/register', data)
         .then((response) => {
            if (response.data.success) {
               ...
               alert("Registration not successful: " + response.data.message);
            }
         })
         .catch((error) => {
            if (error.response && error.response.data && error.response.data.message) {
               alert("Registration not successful: " + error.response.data.message);
            } else {
